...
<footer id="connect" class="bg-[#0000B0] flex flex-col p-10 lg:pr-32 text-2xl lg:gap-0 gap-10">
	...
	>
		...
		<div class="flex flex-col">
			...
			<a class={style.a} href="2024Q4/#about">About</a>
			<a class={style.a} href="2024Q4/#games">Games</a>
			<a class={style.a} href="2024Q4/#projects">Projects</a>
			<a class={style.a} href="2024Q4/music">Music</a>
			<a class={style.a} href="2024Q4/blog">Blog</a>
		</div>
		<div class="flex flex-col">
